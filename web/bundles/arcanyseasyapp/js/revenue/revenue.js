...
function getBalance(id, list) {
	$(document.body).on('change', '#' + id, function() {
		...
		$('[for="'+ id +'"]').after('<span id="bal_for_'+ id +'" rel="'+ list[$(this).val()]['cur_bal'] +'" style="float: right; padding-right: 17px; margin-top: -22px; font-size: 11px;">current balance: $ '+ numberWithCommas(list[$(this).val()]['cur_bal']) +'</span>');
...
function getBalanceOnLoad(id, list) {
	$('[for="'+ id +'"]').after('<span id="bal_for_'+ id +'" rel="'+ list[$('#'+ id).val()]['cur_bal'] +'" style="float: right; padding-right: 17px; margin-top: -22px; font-size: 11px;">current balance: $ '+ numberWithCommas(list[$('#'+ id).val()]['cur_bal']) +'</span>');
